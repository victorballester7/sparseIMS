...
In this part of the project we will use algorithms specifically designed to solve sparse matrices, and we will make a comparison of the performance of these algorithms with the ones used for dense matrices, in terms of the density of the matrix and the size of the matrix.
